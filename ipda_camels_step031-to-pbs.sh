...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "#................................................" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "#${module_mageck}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl1=`grep "${celltype}" ${input} | cut -f5 | sort | uniq`; rep1=`grep "${celltype}" ${input} | cut -f8 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --control-sgrna ${negativectrl} --norm-method control -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_negCtrol-rep1 --sample-label ${file}r1,CTRL1 --fastq ${rep1} ${ctrl1}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl2=`grep "${celltype}" ${input} | cut -f6 | sort | uniq`; rep2=`grep "${celltype}" ${input} | cut -f9 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --control-sgrna ${negativectrl} --norm-method control -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_negCtrol-rep2 --sample-label ${file}r2,CTRL2 --fastq ${rep2} ${ctrl2}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl3=`grep "${celltype}" ${input} | cut -f7 | sort | uniq`; rep3=`grep "${celltype}" ${input} | cut -f10 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --control-sgrna ${negativectrl} --norm-method control -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_negCtrol-rep3 --sample-label ${file}r3,CTRL3 --fastq ${rep3} ${ctrl3}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
# Each replicate individually compared with the CTRL (Day 0) in single-end mode at gene level.
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl1=`grep "${celltype}" ${input} | cut -f5 | sort | uniq`; rep1=`grep "${celltype}" ${input} | cut -f8 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --norm-method median -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_median-rep1 --sample-label ${file}r1,CTRL1 --fastq ${rep1} ${ctrl1}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl2=`grep "${celltype}" ${input} | cut -f6 | sort | uniq`; rep2=`grep "${celltype}" ${input} | cut -f9 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --norm-method median -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_median-rep2 --sample-label ${file}r2,CTRL2 --fastq ${rep2} ${ctrl2}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do libraryfasta=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl3=`grep "${celltype}" ${input} | cut -f7 | sort | uniq`; rep3=`grep "${celltype}" ${input} | cut -f10 | sort | uniq`; echo "python $mageck count --sgrna-len ${guidelen} --norm-method median -l $libraryfasta -n ${out_path_step031_MAGeCK}/${file}_median-rep3 --sample-label ${file}r3,CTRL3 --fastq ${rep3} ${ctrl3}" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
