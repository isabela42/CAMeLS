...
ls ${out_path_step033_summary}/summary_read-counts-* | while read f; do sed '1 i\library\tcell-type\tnorm\tsgRNA-len\tlabel-exp\treads\tmapped-reads\ttotal-sgRNA\tlabel-ctrl\treads\tmapped-reads\ttotal-sgRNA\tvector-size\tparameters' ${f} ; done
