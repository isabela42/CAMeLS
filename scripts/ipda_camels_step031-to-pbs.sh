...
out_path_step031_MAGeCK="camels031_counts-replicates_MAGeCK_${thislogdate}"
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl1=`grep "${celltype}" ${input} | cut -f5 | sort | uniq`; rep1=`grep "${celltype}" ${input} | cut -f8 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl2=`grep "${celltype}" ${input} | cut -f6 | sort | uniq`; rep2=`grep "${celltype}" ${input} | cut -f9 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl3=`grep "${celltype}" ${input} | cut -f7 | sort | uniq`; rep3=`grep "${celltype}" ${input} | cut -f10 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl1=`grep "${celltype}" ${input} | cut -f5 | sort | uniq`; rep1=`grep "${celltype}" ${input} | cut -f8 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl2=`grep "${celltype}" ${input} | cut -f6 | sort | uniq`; rep2=`grep "${celltype}" ${input} | cut -f9 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do librarytsv=`grep "${celltype}" ${input} | cut -f2 | sort | uniq`; guidelen=`grep "${celltype}" ${input} | cut -f3 | sort | uniq`; negativectrl=`grep "${celltype}" ${input} | cut -f4 | sort | uniq`; ctrl3=`grep "${celltype}" ${input} | cut -f7 | sort | uniq`; rep3=`grep "${celltype}" ${input} | cut -f10 | sort | uniq`; rfunction=`grep "${celltype}" ${input} | cut -f11 | sort | uniq`; echo "sed -i.bak -e '143,155d' ${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd ; sed -i \"143 r ${rfunction}\" ${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd; sed -i '70 i library(tidyr)' ${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd; sed -i '70 i library(ggplot2)' ${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript -e \"rmarkdown::render('${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd', output_format = 'html_notebook')\"" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
## Submit PBS jobs 
ls ${pbs_stem}_*${thislogdate}.pbs | while read pbs; do echo ; echo "#................................................" ; echo "# This is PBS: ${pbs}" ;  echo "#" ; echo "# main command line(s): $(tail -n20 ${pbs} | head -n1)" ; echo "#                       $(tail -n19 ${pbs} | head -n1)" ; echo "#                       $(tail -n18 ${pbs} | head -n1)" ; echo "#                       $(tail -n17 ${pbs} | head -n1)" ; echo "#                       $(tail -n16 ${pbs} | head -n1)" ; echo "#                       $(tail -n15 ${pbs} | head -n1)" ; echo "#                       $(tail -n14 ${pbs} | head -n1)" ; echo "#                       $(tail -n13 ${pbs} | head -n1)" ; echo "#                       $(tail -n12 ${pbs} | head -n1)" ; echo "#                       $(tail -n9 ${pbs} | head -n1)" ; echo "#                       $(tail -n8 ${pbs} | head -n1)" ; echo "#                       $(tail -n7 ${pbs} | head -n1)" ; echo "#                       $(tail -n6 ${pbs} | head -n1)" ; echo "#                       $(tail -n5 ${pbs} | head -n1)" ; echo "#                       $(tail -n4 ${pbs} | head -n1)" ; echo "#                       $(tail -n3 ${pbs} | head -n1)" ; echo "#                       $(tail -n2 ${pbs} | head -n1)" ; echo "#                       $(tail -n1 ${pbs})" ; echo "#" ; echo "# now submitting PBS" ; echo "qsub ${pbs}" ; qsub ${pbs} ; echo "#................................................" ; done
