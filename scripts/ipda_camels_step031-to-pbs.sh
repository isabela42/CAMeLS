...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep1.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep2.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_nctrl-rep3.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
cut -f1 ${input} | sort | uniq | while read celltype; do echo "" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_median-rep1.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_median-rep2.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
...
cut -f1 ${input} | sort | uniq | while read celltype; do echo "Rscript ${out_path_step031_MAGeCK}/${celltype}_median-rep3.count_report.Rmd" >> ${pbs_stem}_${celltype}_${thislogdate}.pbs; done
